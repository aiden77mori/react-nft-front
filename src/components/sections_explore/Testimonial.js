        ...
        <div className={innerClasses}>
          ...
          <div className={tilesClasses}>
            ...
            <div className="slide-item-tablecell design hx home-explore">
              <div className="explore-design_explore">
                <span>Artist <Link to="/artists"><strong>KIDEIGHT</strong></Link></span>
                <span style={{marginLeft:'15px'}}>Owner <strong>ETH</strong></span>
                <div className="right mp threedot threedot" style={{cursor: 'pointer'}}>
